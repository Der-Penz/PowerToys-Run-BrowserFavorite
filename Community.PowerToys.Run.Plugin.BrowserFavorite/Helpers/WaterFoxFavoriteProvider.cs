...
public class WaterFoxFavoriteProvider : IFavoriteProvider
{
    ...
    public WaterFoxFavoriteProvider()
    {
    ...
    {
        string profilesPath = Environment.ExpandEnvironmentVariables(@"%APPDATA%\Waterfox\Profiles");
        ...
        throw new DirectoryNotFoundException("No default-release folder found in Waterfox profiles.");
    }
